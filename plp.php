...
<section class="merch">
    <div class="container">
        <div class="merch__head">
            <h2 class="merch__title">SHOP NOWADAYS</h2>
        </div>
        <div class="merch__products">
            <div class="merch-product">
                <div class="merch-product__image merch-product__one">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/Nowadays_micro_dose.webp'">
                    <?php $background_product = get_field( 'background_product' ); ?>
                </div>
                <div class="merch-product__info">
                    ...
                    <p class="merch-product__description">2mg thc drink</p>
                    <p class="merch-product__bottle">750 ml/33mg per bottle</p>
                    <p class="merch-product__price">$39.99</p>
                    <a href="#" class=" btn btn__beige--small">Add to card</a>
                </div>
            </div>
            <div class="merch-product">
                <div class="merch-product__image sn-product__two">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/Nowadays_micro_dose.webp'">
                </div>
                <div class="merch-product__info">
                    ...
                    <p class="merch-product__description">6mg thc drink</p>
                    <p class="merch-product__bottle">750 ml/100mg per bottle</p>
            ...
            <div class="merch-product">
                <div class="sn-product__image sn-product__three">
                    <img class="merch-product__img" src="<?php echo get_template_directory_uri(); ?>'/img/Nowadays_micro_dose.webp'">
                </div>
                <div class="merch-product__info">
                    ...
                    <p class="merch-product__description">10mg thc drink</p>
                    <p class="merch-product__bottle">750 ml/166mg per bottle</p>
            ...
            <div class="merch-product">
                <div class="merch-product__image ">
                    <img class="merch-product__infocards" src="<?php echo get_template_directory_uri(); ?>/img/PLP_infoCards_1.png'">
                </div>
        </div>
        </div>
    </div>
